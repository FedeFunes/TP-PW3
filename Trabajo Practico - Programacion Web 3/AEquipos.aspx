        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                <div class="form-group">
                    ...
                    <asp:RegularExpressionValidator ID="ValidaNombreEquipo2" runat="server" ErrorMessage="Campo Nombre: Solo letras." Text="(*)" ValidationExpression="([A-Z]|[a-z])+" ControlToValidate="txtNombreEquipo" Display="Dynamic" EnableClientScript="false"></asp:RegularExpressionValidator>
                    <span class="errorForm text-danger" id="errorNombreEquipo">Error: Campo vacio o el nombre no son solo letras.</span>
                </div>
                ...
                <div class="form-group">
                    ...
                    <span class="errorForm text-danger" id="errorMontoAbonado">Error: Campo vacio o el monto no son solo numeros.</span>
                </div>
